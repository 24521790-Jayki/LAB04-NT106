...
{
    // Class Bai04 PHẢI nằm đầu tiên để không lỗi Designer
    public partial class Bai04 : Form
    {
        ...
        private void SaveToJson(List<Movie> data, string path)
        {
            try
            {
                // ĐÃ SỬA: Chỉ định rõ Newtonsoft.Json.Formatting để tránh lỗi Ambiguous
    ...
    // ĐÃ SỬA: Di chuyển class Movie xuống dưới cùng (ngoài class Bai04 nhưng trong namespace)
    public class Movie
    {
